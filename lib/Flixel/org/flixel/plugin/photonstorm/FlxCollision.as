...
package org.flixel.plugin.photonstorm 
{
	...
	{
		public static var debug:BitmapData = new BitmapData(1, 1, true);
		 ...
		 */
		public static function pixelPerfectCheck(contact:FlxSprite, target:FlxSprite, alphaTolerance:int = 255,rotatedPixels:BitmapData=null):Boolean
		{
			var boundsA:Rectangle
			if (rotatedPixels)
			{
				boundsA = new Rectangle(0, 0, rotatedPixels.width, rotatedPixels.height);
			}
			else
			{
				boundsA = new Rectangle(contact.x, contact.y, contact.width, contact.height);
			}
			...
			var testA:BitmapData = rotatedPixels == null ? contact.framePixels : rotatedPixels;
		...
		public static function pixelPerfectCheckRect(contact:FlxSprite, target:FlxSprite, alphaTolerance:int = 255, rotatedPixels:BitmapData=null):Rectangle
		{
			var boundsA:Rectangle
			if (rotatedPixels)
			{
				boundsA = new Rectangle(contact.x, contact.y, rotatedPixels.width, rotatedPixels.height);
			}
			else
			{
				boundsA = new Rectangle(contact.x, contact.y, contact.width, contact.height);
			...
			var testA:BitmapData = rotatedPixels == null ? contact.framePixels : rotatedPixels;
			var testB:BitmapData = target.framePixels;
			var overlapArea:BitmapData = new BitmapData(intersect.width, intersect.height, true);
