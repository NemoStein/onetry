package org.flixel
{
	...
	public class FlxObject extends FlxBasic
	{
		 ...
		 */
		private var _allowCollisions:uint;
		...
		/**
		 * Support for togglable state reverting to the state it was before removing collision.
		 */
		protected var _lastSolidState:uint;
		...
		public function set solid(Solid:Boolean):void
		{
			if(Solid)
			{
				_allowCollisions = _lastSolidState;
			}
			else
			{
				_lastSolidState = allowCollisions;
				_allowCollisions = NONE;
			}
		}
		
		public function get allowCollisions():uint 
		{
			return _allowCollisions;
		}
		
		public function set allowCollisions(value:uint):void 
		{
			_lastSolidState = _allowCollisions = value;
		}
