package sourbit.games.onetry.map 
{
	...
	public class ZoomCamera extends FlxCamera
	{
		...
		{	
			...
			x = -(width  / 2) * offsetX * (zoom - defaultZoom);		
			y = -(height / 2) * offsetY * (zoom - defaultZoom);
		}
